<?php
    ...
    $qry = "SELECT * FROM willdev_smtp_settings where id='1'";
    ...
    if (isset($_POST['submit'])) {
      ...
      $sql = "SELECT * FROM willdev_smtp_settings WHERE id='1'";
      $res = mysqli_query($mysqli, $sql) or die(mysqli_error($mysqli));

      if (mysqli_num_rows($res) > 0) {
        $update = Update('willdev_smtp_settings', $data, "WHERE id = '1'");
      } else {
        $insert = Insert('willdev_smtp_settings', $data);
      }
